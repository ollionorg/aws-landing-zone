package rules.tf_aws_securty_group_ingress_5432
...
policy[j] {
  ...
  msg = library.deny_security_group_ingress_zero_cidr_to_port_lb(global_sg_id, sg, 5432)
  j = fugue.deny_resource_with_message(sg, msg)
} {
  sg = security_groups[global_sg_id]
  not library.deny_security_group_ingress_zero_cidr_to_port_lb(global_sg_id, sg, 5432)
