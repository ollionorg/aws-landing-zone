...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_permissionset-report"></a> [permissionset-report](#module\_permissionset-report) | ../../terraform/modules/permissionset-compliance/report | n/a |
...
| Name | Description |
|------|-------------|
| <a name="output_permissionset_report_rolename"></a> [permissionset\_report\_rolename](#output\_permissionset\_report\_rolename) | PermissionSet Report Lambda Function IAM Role Name |