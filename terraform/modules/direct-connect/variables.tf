...
variable "direct_connect_static_routes_destinations" {
  type        = list(string)
...
variable "transit_gateway_route_table_id" {
  description = "The ID of the Transit Gateway Route Table Where We Need To Add Static Route."
  type        = string
  default     = null
}
...
variable "allowed_prefixes" {
  type        = list(string)
  description = "List of CIDR blocks to be added in gateway association proposal`"
  default     = []
}