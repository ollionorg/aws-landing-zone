...
| <a name="input_logging_group_prefix"></a> [logging\_group\_prefix](#input\_logging\_group\_prefix) | Logging group prefix | `string` | `"/aws/network-firewall"` | no |
...
| <a name="input_stateless_rule_group"></a> [stateless\_rule\_group](#input\_stateless\_rule\_group) | Config for stateless rule group | `any` | `[]` | no |
...
| <a name="output_subnet_id"></a> [subnet\_id](#output\_subnet\_id) | Created Network Firewall subnets id |
| <a name="output_subnet_mapping"></a> [subnet\_mapping](#output\_subnet\_mapping) | n/a |
<!-- END_TF_DOCS -->
