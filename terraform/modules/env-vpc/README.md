...
| [aws_network_acl.tgw_attachment](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/network_acl) | resource |
...
| [aws_network_acl_rule.tgw_attachment_inbound](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/network_acl_rule) | resource |
| [aws_network_acl_rule.tgw_attachment_outbound](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/network_acl_rule) | resource |
...
| [aws_route.tgw_attachment_ipv6_egress](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/route) | resource |
| [aws_route.tgw_attachment_nat_gateway](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/route) | resource |
...
| [aws_route_table.tgw_attachment](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/route_table) | resource |
...
| [aws_route_table_association.tgw_attachment](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/route_table_association) | resource |
...
| [aws_subnet.tgw_attachment](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/subnet) | resource |
...
| <a name="input_tgw_attachment_acl_tags"></a> [tgw\_attachment\_acl\_tags](#input\_tgw\_attachment\_acl\_tags) | Additional tags for the TGW attachment subnets network ACL | `map(string)` | `{}` | no |
| <a name="input_tgw_attachment_dedicated_network_acl"></a> [tgw\_attachment\_dedicated\_network\_acl](#input\_tgw\_attachment\_dedicated\_network\_acl) | Whether to use dedicated network ACL (not default) and custom rules for TGW attachment subnets | `bool` | `false` | no |
| <a name="input_tgw_attachment_inbound_acl_rules"></a> [tgw\_attachment\_inbound\_acl\_rules](#input\_tgw\_attachment\_inbound\_acl\_rules) | TGW attachment subnets inbound network ACLs | `list(map(string))` | <pre>[<br>  {<br>    "cidr_block": "0.0.0.0/0",<br>    "from_port": 0,<br>    "protocol": "-1",<br>    "rule_action": "allow",<br>    "rule_number": 100,<br>    "to_port": 0<br>  }<br>]</pre> | no |
| <a name="input_tgw_attachment_outbound_acl_rules"></a> [tgw\_attachment\_outbound\_acl\_rules](#input\_tgw\_attachment\_outbound\_acl\_rules) | TGW attachment subnets outbound network ACLs | `list(map(string))` | <pre>[<br>  {<br>    "cidr_block": "0.0.0.0/0",<br>    "from_port": 0,<br>    "protocol": "-1",<br>    "rule_action": "allow",<br>    "rule_number": 100,<br>    "to_port": 0<br>  }<br>]</pre> | no |
| <a name="input_tgw_attachment_route_table_tags"></a> [tgw\_attachment\_route\_table\_tags](#input\_tgw\_attachment\_route\_table\_tags) | Additional tags for the TGW attachment route tables | `map(string)` | `{}` | no |
| <a name="input_tgw_attachment_subnet_assign_ipv6_address_on_creation"></a> [tgw\_attachment\_subnet\_assign\_ipv6\_address\_on\_creation](#input\_tgw\_attachment\_subnet\_assign\_ipv6\_address\_on\_creation) | Assign IPv6 address on TGW attachment subnet, must be disabled to change IPv6 CIDRs. This is the IPv6 equivalent of map\_public\_ip\_on\_launch | `bool` | `null` | no |
| <a name="input_tgw_attachment_subnet_ipv6_prefixes"></a> [tgw\_attachment\_subnet\_ipv6\_prefixes](#input\_tgw\_attachment\_subnet\_ipv6\_prefixes) | Assigns IPv6 TGW attachment subnet id based on the Amazon provided /56 prefix base 10 integer (0-256). Must be of equal length to the corresponding IPv4 subnet list | `list(string)` | `[]` | no |
| <a name="input_tgw_attachment_subnet_names"></a> [tgw\_attachment\_subnet\_names](#input\_tgw\_attachment\_subnet\_names) | Explicit values to use in the Name tag on TGW attachment subnets. If empty, Name tags are generated. | `list(string)` | `[]` | no |
| <a name="input_tgw_attachment_subnet_suffix"></a> [tgw\_attachment\_subnet\_suffix](#input\_tgw\_attachment\_subnet\_suffix) | Suffix to append to TGW attachment subnets name | `string` | `"tgwa"` | no |
| <a name="input_tgw_attachment_subnet_tags"></a> [tgw\_attachment\_subnet\_tags](#input\_tgw\_attachment\_subnet\_tags) | Additional tags for the TGW attachment subnets | `map(string)` | `{}` | no |
| <a name="input_tgw_attachment_subnet_tags_per_az"></a> [tgw\_attachment\_subnet\_tags\_per\_az](#input\_tgw\_attachment\_subnet\_tags\_per\_az) | Additional tags for the TGW attachment where the primary key is the AZ | `map(map(string))` | `{}` | no |
| <a name="input_tgw_attachment_subnets"></a> [tgw\_attachment\_subnets](#input\_tgw\_attachment\_subnets) | A list of TGW attachment subnets inside the VPC | `list(string)` | `[]` | no |
...
| <a name="output_tgw_attachment_ipv6_egress_route_ids"></a> [tgw\_attachment\_ipv6\_egress\_route\_ids](#output\_tgw\_attachment\_ipv6\_egress\_route\_ids) | List of IDs of the ipv6 egress route |
| <a name="output_tgw_attachment_nat_gateway_route_ids"></a> [tgw\_attachment\_nat\_gateway\_route\_ids](#output\_tgw\_attachment\_nat\_gateway\_route\_ids) | List of IDs of the tgw attachment nat gateway route |
| <a name="output_tgw_attachment_network_acl_arn"></a> [tgw\_attachment\_network\_acl\_arn](#output\_tgw\_attachment\_network\_acl\_arn) | ARN of the tgw attachment network ACL |
| <a name="output_tgw_attachment_network_acl_id"></a> [tgw\_attachment\_network\_acl\_id](#output\_tgw\_attachment\_network\_acl\_id) | ID of the tgw attachment network ACL |
| <a name="output_tgw_attachment_route_table_association_ids"></a> [tgw\_attachment\_route\_table\_association\_ids](#output\_tgw\_attachment\_route\_table\_association\_ids) | List of IDs of the tgw attachment route table association |
| <a name="output_tgw_attachment_route_table_ids"></a> [tgw\_attachment\_route\_table\_ids](#output\_tgw\_attachment\_route\_table\_ids) | List of IDs of tgw attachment route tables |
| <a name="output_tgw_attachment_subnet_arns"></a> [tgw\_attachment\_subnet\_arns](#output\_tgw\_attachment\_subnet\_arns) | List of ARNs of tgw attachment subnets |
| <a name="output_tgw_attachment_subnets"></a> [tgw\_attachment\_subnets](#output\_tgw\_attachment\_subnets) | List of IDs of tgw attachment subnets |
| <a name="output_tgw_attachment_subnets_cidr_blocks"></a> [tgw\_attachment\_subnets\_cidr\_blocks](#output\_tgw\_attachment\_subnets\_cidr\_blocks) | List of cidr\_blocks of tgw attachment subnets |
| <a name="output_tgw_attachment_subnets_ipv6_cidr_blocks"></a> [tgw\_attachment\_subnets\_ipv6\_cidr\_blocks](#output\_tgw\_attachment\_subnets\_ipv6\_cidr\_blocks) | List of IPv6 cidr\_blocks of tgw attachment subnets in an IPv6 enabled VPC |
